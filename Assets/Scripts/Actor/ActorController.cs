...
public class ActorController : MonoBehaviour
{
	...
	[Header("信号隠れ設定")]
	[Tooltip("赤信号から隠れているかどうかのフラグ")]
	public bool isHiddenFromRedLight = false;
	...
	/// <summary>
	/// 外部から赤信号から隠れるモードを切り替えるメソッド
	/// </summary>
	/// <param name="isHidden">隠れるかどうか</param>
	public void SetHiddenFromRedLight(bool isHidden)
	{
		isHiddenFromRedLight = isHidden;
